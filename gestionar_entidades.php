...
<body>
    ...
    <div class="header">
        ...
        <div class="content"> 
            <div class="title">AGREGAR ENTIDADES Y REFERENTES</div> 
            <div class="buttons"> 
                <input class="button" type="text" placeholder="NOMBRE">
                <input class="button" type="text" placeholder="SECTOR">
                <input class="button" type="text" placeholder="DIRECCION">
                <input class="button" type="text" placeholder="REFERENTES">
            </div>
