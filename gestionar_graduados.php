...
<body>
    ...
    <div class="header">
        ...
        <div class="content_alumnos"> 
            ...
            <div class="buttons"> 
                <input class="button" type="text" placeholder="CARRERA">
                <input class="button" type="text" placeholder="AÑO GRADUACION">
                <input class="button" type="text" placeholder="ESTUDIOS POSTERIORES">
                <input class="button" type="text" placeholder="AREA DE INTERES">
                <input class="button" type="text" placeholder="OBSERVACIONES">
                <input class="button" type="text" placeholder="RELACIONAR">
            </div>
